    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
			    ...
			    <?php
				$sql2 = "select count(*) from dropout_details";
				$result2 = mysqli_query($conn,$sql2);
				$row = mysqli_fetch_array($result2);
				$total = $row[0];
				$sql3 = "select count(distinct school_id) from dropout_details";
                                ...
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title"><?php echo "Total Dropout Student:"." ".$total."<br> "."Total Schools:"." ".$total1.""; ?></h4> <br>
