...
<head>
        ...
        <title>Schools :: Student Dropout Analysis Portal</title>
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                                    ...
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                            <ol class="breadcrumb hide-phone p-0 m-0">
                                                ...
                                                <li class="breadcrumb-item active">All School Details</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">All School Details</h4>
                                    </div>
                                </div>
                            </div>
			    ...
			    <?php
				$sql2 = "select count(*) from school_details";
                                ...
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title"><?php echo "Total Schools:"." ".$total.""; ?></h4> <br>
