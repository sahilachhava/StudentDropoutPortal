        ...
        <div id="wrapper">
            ...
            <div class="content-page">
			    ...
			    <!-- dashboard content write below-->
			        <?php
				$sql2 = "select count(*) from student_details";
				$result2 = mysqli_query($conn,$sql2);
				$row = mysqli_fetch_array($result2);
				$total = $row[0];
				$sql3 = "select count(distinct school_id) from student_details";
                                ...
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title"><?php echo "Total Enrolled Student:"." ".$total."<br> "."Total Schools:"." ".$total1.""; ?></h4> <br>
