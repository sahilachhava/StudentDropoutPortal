...
<head>
        ...
        <title>Add New School :: Student Dropout Analysis Portal</title>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title">Add New School</h4>
                                    </div>
                                </div>
                            </div>
			    ...
			    <div class="row">
					...
					<form action="<?php $_PHP_SELF ?>" method="post">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="name" placeholder="School Name" value="" id="example-text-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-sm-2 col-form-label">Street</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="street" value="" placeholder="Street Address" id="example-search-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="email" value="" placeholder="example@example.com" name="mail" id="example-time-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-color-input" class="col-sm-2 col-form-label">Phone Number</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" value="" placeholder="(+91) 0000000000" data-mask="0000000000" name="phone" id="example-color-input">
                                                </div>
                                            </div>
					<div class="form-group">
					 <label for="example-time-input" class="col-sm-2 col-form-label" ></label>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                        <button type="submit" class="btn btn-primary waves-effect waves-light">Add School</button>
...
<?php
	if(isset($_POST['name']))
	{
		...
		$sql = "insert into school_details(name,street,area,city,state,pincode,email,phone) values('$name','$street','$area','$city','$state','$pin','$mail','$phone')";
