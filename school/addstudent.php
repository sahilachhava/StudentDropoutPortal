...
<!-- Plugins css -->
			    ...
			    <div class="row">
					...
					<form action="<?php $_PHP_SELF; ?>" method="post">					
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="name" placeholder="Full Name" value="" id="example-text-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-search-input" class="col-sm-2 col-form-label">Father Name</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="fname" value="" placeholder="Father Name" id="example-search-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-url-input" class="col-sm-2 col-form-label">Street</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="street" value="" placeholder="Street Address" id="example-url-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-tel-input" class="col-sm-2 col-form-label">Area</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" value="" name="area" placeholder="Area / Landmark" id="example-tel-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-password-input" class="col-sm-2 col-form-label">City</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" value="" name="city" placeholder="City" id="example-password-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-number-input" class="col-sm-2 col-form-label">State</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" value="" name="state" placeholder="State" id="example-number-input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="example-datetime-local-input" class="col-sm-2 col-form-label">Pincode</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" placeholder="000000" data-mask="000000" name="pin" value="" id="example-datetime-local-input">
                                                </div>
                                            </div>
					    <div class="form-group row">
                                                <label for="example-month-input" class="col-sm-2 col-form-label">Date of Birth</label>
                                                <div class="col-sm-10">
                                                    <!--<input class="form-control" type="text" placeholder="DD/MM/YYYY" data-mask="**/**/****" name="dob" value="" id="example-month-input">-->
						<input type="text" class="form-control" placeholder="YYYY-MM-DD" name="dob" id="mdate">
                                                </div>
                                            </div>
					<div class="form-group row">
 ...
 <!-- Sweet-Alert  -->
	 ...
	 <!--<script src="assets/pages/sweet.js"></script>-->
...
<?php
	...
	'$month','$year','$cast','$gender','$std','$jyear',NULL,'$school')";
