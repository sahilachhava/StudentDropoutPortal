...
$query = "SELECT area, count(area) as number  FROM dropout_details GROUP BY area";  
...
<head>
        ...
        <title>Area Wise -Pie Chart :: Student Dropout Analysis Portal</title>
                                    ...
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                            <ol class="breadcrumb hide-phone p-0 m-0">
                                                ...
                                                <li class="breadcrumb-item active">Area Wise</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Student Drop Analysis (Area Wise)</h4>
                                    </div>
                                </div>
                            </div>
