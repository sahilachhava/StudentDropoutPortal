...
<head>
        ...
        <title>School Wise - Bar Chart :: Student Dropout Analysis Portal</title>
                                    ...
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                            <ol class="breadcrumb hide-phone p-0 m-0">
                                                ...
                                                <li class="breadcrumb-item active">School Wise</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Student Drop Analysis (School Wise)</h4>
                                    </div>
                                </div>
                            </div>
			    ...
			    <!-- dashboard content write below-->
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <p class="text-muted m-b-30 font-14">Display as School Wise Bar Chart.</p>
	...
	!function($) {
		...
		c3.generate({
		    ...
		    data: {
			columns: [
				['School', <?php echo $d1; ?>, 130, 90, 240, 130, 220],
			],
			type: 'bar',
			colors: {
			    School: '#6c757d'
