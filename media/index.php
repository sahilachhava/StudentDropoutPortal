    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
			...
			<label for="example-month-input" class="col-sm-1 col-form-label">Year</label>
						...
						<label for="example-time-input" class="col-sm-0.5 col-form-label" ></label>
                                                    <div class="col-sm-1">
					...
					<th>Reason</th>
                                                ...
                                                <tbody>
                                                <?php
						if(isset($_REQUEST['year']) or isset($_REQUEST['school']) or isset($_REQUEST['gender']) or isset($_REQUEST['cast']))
						{
							include("../connection.php");
							$s = $_REQUEST['school'];
