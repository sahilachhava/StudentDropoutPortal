...
$query = "SELECT gender, count(gender) as number  FROM dropout_details GROUP BY gender";  
...
<head>
        ...
        <title>Gender Wise -Pie Chart :: Student Dropout Analysis Portal</title>
                                    ...
                                    <div class="page-title-box">
                                        <div class="btn-group float-right">
                                            <ol class="breadcrumb hide-phone p-0 m-0">
                                                ...
                                                <li class="breadcrumb-item active">Gender Wise</li>
                                            </ol>
                                        </div>
                                        <h4 class="page-title">Student Drop Analysis (Gender Wise)</h4>
                                    </div>
                                </div>
                            </div>
