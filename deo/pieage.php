...
$query = "SELECT day,month,year,count(*) as number  FROM dropout_details GROUP BY day,month,year";  
...
<head>
        ...
        <title>Age Wise -Pie Chart :: Student Dropout Analysis Portal</title>
